...
**Acadêmico**
- 🎓 **Tecnólogo em Ciência de Dados** | GRAN (*5º Período*)
- 🎓 **Bacharelado em Estatística** | FMU (*Em andamento*)
- 🎓 **Técnico em Informática** | IFSUL (*Integrado ao Ensino Médio*)
...
Aqui estão os códigos e projetos desenvolvidos durante minha jornada acadêmica:

| Instituição | Repositório | Descrição | Stack |
| :--- | :--- | :--- | :--- |
| **IFSUL** | **[IFSUL-TecnicoInformatica-LouiseALD](#)** | Todos os projetos realizados durante meu curso técnico de informática. | Java |
| **GRAN** | **[GRAN-CienciaDeDados-LouiseALD](#)** | Projetos e laboratórios do curso de Ciência de Dados. | Python/SQL |
| **FMU** | **[FMU-Estatistica-LouiseALD](#)** | Atividades realizadas no Bacharelado em Estatística. | Jupyter Notebook |
